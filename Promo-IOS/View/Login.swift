...
struct Login: View {
    ...
    @State private var showCreateAccount = false   // 👈 controle da navegação
    
    var body: some View {
        NavigationStack { // 👈 envolve tudo para habilitar navegação
            ZStack(alignment: .top) {
                ...
                VStack(spacing: 20) {
                    ...
                    HStack {
                        ...
                        Button(action: {
                            showCreateAccount = true   // 👈 abre a tela de criar conta
                        }) {
                            Text("Cadastre-se!")
                                .foregroundColor(.white)
                                .font(.system(size: 20))
            ...
            // 🔥 Quando autenticar, abre a LayoutUserView
